...
public class TipoUsuario {
    ...
    public TipoUsuario(Integer id_tipo_usuario, String glosa_tipo_usuario, String rut_creacion, String fecha_creacion, String rut_actualizacion, String fecha_actualizacion) {
    ...
    public String toString() {
        return "TipoUsuario{" + "id_tipo_usuario=" + id_tipo_usuario + ", glosa_tipo_usuario=" + glosa_tipo_usuario + ", rut_creacion=" + rut_creacion + ", fecha_creacion=" + fecha_creacion + ", rut_actualizacion=" + rut_actualizacion + ", fecha_actualizacion=" + fecha_actualizacion + '}';
    }
